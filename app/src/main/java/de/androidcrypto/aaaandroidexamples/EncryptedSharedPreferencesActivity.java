...
public class EncryptedSharedPreferencesActivity extends AppCompatActivity {

    private final String TAG = "EncryptedSharedPrefsAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EncryptedSharedPreferencesActivity.this, MainActivity.class);
